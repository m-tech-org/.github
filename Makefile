# Makefile — release & preview tooling for the m-tech-org/.github profile README.
#
# Quick start:
#   make show              preview profile/README.md rendered in the browser
...
# --- Configuration (override on the command line, e.g. `make all FILES="profile/README.md Makefile"`) ---
BRANCH_NAME ?= master
MD_FILE     ?= profile/README.md
...
commit: ## Stage FILES (default: profile/README.md) and commit as "updated to <next tag>"
...
show: ## Render MD_FILE (default profile/README.md) to HTML and open it in the browser
...
help: ## Show this help message
	...
	@echo "  FILES         files staged/committed by 'commit'/'all' (default: profile/README.md)"
	@echo "  MD_FILE       markdown file rendered by 'show' (default: profile/README.md)"
